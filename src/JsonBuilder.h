...
class JsonBuilder {
	public:
		...
		void process_asr_message(google::cloud::speech::v1::StreamingRecognizeResponse response, std::string id);
		
		// Process a word/feature alignment message
		void process_alignment_message(google::cloud::speech::v1::StreamingRecognizeResponse response, std::string id);
